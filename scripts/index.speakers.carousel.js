...
const slides = [
  '<article class="speakers__card">\
        <a href="product.html" class="link-to-product-page" data-id="jbl_br-55"><img class="speakers__card-image" src="assets/images/speakers_pics/jbl_br-55.png" alt="Speaker model JBL BR-55"></a>\
  ...
  '<article class="speakers__card">\
        <a href="product.html" class="link-to-product-page" data-id="jbl_gt-345"><img class="speakers__card-image" src="assets/images/speakers_pics/jbl_gt-345.png" alt="Speaker model JBL GT-345"></a>\
  ...
  '<article class="speakers__card">\
        <a href="product.html" class="link-to-product-page" data-id="jbl_or-57"><img class="speakers__card-image" src="assets/images/speakers_pics/jbl_or-57.png" alt="Speaker model JBL OR-57"></a>\
  ...
  '<article class="speakers__card">\
        <a href="product.html" class="link-to-product-page" data-id="jbl_party_pt-25"><img class="speakers__card-image" src="assets/images/speakers_pics/jbl_party_pt-25.png" alt="Speaker model JBL Party PT-25"></a>\
  ...
  '<article class="speakers__card">\
        <a href="product.html" class="link-to-product-page" data-id="jbl_rr-56"><img class="speakers__card-image" src="assets/images/speakers_pics/jbl_rr-56.png" alt="Speaker model JBL RR-56"></a>\
  ...
  '<article class="speakers__card">\
        <a href="product.html" class="link-to-product-page" data-id="sony_yt555"><img class="speakers__card-image" src="assets/images/speakers_pics/sony_yt555.png" alt="Speaker model Sony YT555"></a>\
